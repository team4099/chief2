    ...
    <div class="items-middle justify-center align-center">
      <div class="justify-center align-middle items-center shadow-2xl p-8 m-8 rounded-xl">
        ...
        <div class="mb-10">
          ...
          <div class="m-4">
            <p class="font-bold">Counter Defense Rating</p>
            <RadioWidget />
          </div>
        </div>
        ...
        <div class="mb-10">
          ...
          >
            <option value="Very Poor" class="bg-amber-400">Very Poor</option>
        ...
        <div class="m-4">
          ...
          <textarea id="" rows="5" cols="20" class="w-full rounded-md border-[#7b7b7b] focus:round-neutral-900 focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-amber-400">
          </textarea>
        </div>
      </div>
    </div>
